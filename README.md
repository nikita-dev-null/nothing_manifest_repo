...
Используйте код с осторожностью.Ваше устройство — ваше дело. Автор данного проекта не несет никакой ответственностиза повреждение вашего телефона, потерю данных, сгоревшие SD-карты или проблемыс законом, возникшие в результате использования данного программного обеспечения.Вы устанавливаете это ядро на свой страх и риск. Программное обеспечениепредоставляется "КАК ЕСТЬ" (AS IS), без каких-либо явных или подразумеваемых гарантий.
